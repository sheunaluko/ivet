...
function mapStateToProps(state, ownProps) {
  return {
    opts : state.data_ports[ownProps.id]
  };
} 


class SubscribingBoxPlot extends React.Component {
...
// function SubscribingBoxPlot(props) { 
...
export default connect(mapStateToProps)(SubscribingBoxPlot) 
