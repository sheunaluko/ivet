...
//  created new file for cloud Tue Dec 17 20:00:11 EST 2019
...
// firebase is initialized  is index.html file 
export var db = window.firebase.firestore() 
// BY THE WAY!! 
/* 
 THE FOLLOWING LINE IS REQUIRED IN THE INDEX FILE IN ORDER FOR THE window.firebase object to CONTAIN the key window.firebase.firestore 
 <script src="https://www.gstatic.com/firebasejs/7.8.1/firebase-firestore.js"></script>  <!-- this is necessary for firestore access --> 
 It is not well documented, but it does appear that the above script is required , and moreover, that it does not overwrite the global firestore object but 
 instead detects it and adds additional functionality to it lmao. 
 
 Would be nice to have some documentation of this. However, great i figured this out. I originally was updatng the firebase js deps in order to integrate analytics functionality, so i removed the other firebase link (which was actually for firestore). Big mistake 
 */ 
